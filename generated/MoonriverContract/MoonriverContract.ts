...
export class MoonriverContract__votingForResultValue0Struct extends ethereum.Tuple {
  get trackId(): i32 {
    return this[0].toI32();
  }
...
export class MoonriverContract extends ethereum.SmartContract {
  static bind(address: Address): MoonriverContract {
    return new MoonriverContract("MoonriverContract", address);
  }
  ...
  votingFor(
    who: Address,
    trackId: i32
  ): Array<MoonriverContract__votingForResultValue0Struct> {
    let result = super.call(
      "votingFor",
    ...
    return result[0].toTupleArray<
      MoonriverContract__votingForResultValue0Struct
    >();
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<MoonriverContract__votingForResultValue0Struct>()
    );
  }
}
